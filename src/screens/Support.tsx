...
import { Truck, MessageSquare, Gamepad2, Mail, HelpCircle, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  return (
    <div className="flex-grow pt-32 pb-24 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full relative z-10">
      ...
      <div className="text-center mb-16 relative">
        ...
        <h1 className="font-display-lg-mobile md:font-display-lg text-primary mb-4 text-glow">How can we help you?</h1>
        <p className="font-body-lg text-on-surface-variant max-w-2xl mx-auto">Track your digital delivery, find answers in our FAQ, or connect with our support squad for immediate assistance.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
        ...
        <div className="md:col-span-8 glass-panel tech-clip p-8 flex flex-col justify-center">
          ...
          <p className="font-body-md text-on-surface-variant mb-6">Enter your Order ID to see the status of your digital delivery or gift card code.</p>
        ...
        <div className="md:col-span-4 flex flex-col gap-gutter">
          ...
          >
            ...
            <div>
              <h3 className="font-label-sm text-on-surface mb-1">WhatsApp Live Chat</h3>
              <p className="font-body-md text-on-surface-variant text-sm">24/7 Instant Support</p>
            </div>
          </motion.a>
          ...
          >
            ...
            <div>
              <h3 className="font-label-sm text-on-surface mb-1">Community Discord</h3>
              <p className="font-body-md text-on-surface-variant text-sm">Join the discussion</p>
            </div>
          </motion.a>

          <motion.a 
            href={settings?.contactInfo?.email ? (settings.contactInfo.email.startsWith('mailto:') ? settings.contactInfo.email : `mailto:${settings.contactInfo.email}`) : "#"}
            whileHover={{ scale: 1.03, x: 5 }}
            whileTap={{ scale: 0.98 }}
            transition={{ type: "spring", stiffness: 400, damping: 25 }}
            className="glass-panel tech-clip p-6 flex items-center gap-4 group transition-shadow duration-300 hover:shadow-[0_10px_30px_-10px_#00ffcc60] hover:border-primary/30"
          >
            ...
            <div>
              <h3 className="font-label-sm text-on-surface mb-1">Email Support</h3>
              <p className="font-body-md text-on-surface-variant text-sm">Responses within 24h</p>
            </div>
          </motion.a>
        </div>
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="border-b border-white/5 last:border-0">
                ...
                >
                  ...
                  {openFaq === i ? <ChevronUp className="text-primary" /> : <ChevronDown className="text-outline" />}
                </button>
                {openFaq === i && (
                  <motion.div 
