...
import { auth, createUserWithEmailAndPassword, signInWithPopup, GoogleAuthProvider, FacebookAuthProvider, OAuthProvider, signInWithDemoMode } from '../firebase';
  ...
  return (
    <div className="flex-grow flex flex-col items-center justify-center py-20 px-4 bg-[#070721] min-h-screen relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 flex flex-col items-center">
        ...
        <AuthHeader title="Create Account" subtitle="Create an account to get started" />
        ...
        >
          ...
          <div className="mt-8 text-center">
            <p className="text-[#9A8F9E] text-sm font-semibold">
              ...
              <button onClick={() => onNavigate('signin')} className="text-[#A288E3] hover:text-white hover:underline font-bold transition-colors">
                Login
              </button>
            </p>
          </div>
