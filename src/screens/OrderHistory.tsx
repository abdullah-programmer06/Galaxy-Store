        ...
        {userOrders.length > 0 ? (
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              >
                <div
                  className={`text-xs uppercase font-semibold tracking-wider mb-1 ${filter === "All" ? "text-white" : "text-on-surface-variant"}`}
                >
                  Total Orders
                </div>
              ...
              >
                <div className="text-green-400 text-xs uppercase font-semibold tracking-wider mb-1">
                  Completed
                </div>
              ...
              >
                <div className="text-yellow-400 text-xs uppercase font-semibold tracking-wider mb-1">
                  Pending
                </div>
              ...
              >
                <div className="text-red-400 text-xs uppercase font-semibold tracking-wider mb-1">
                  Cancelled
                </div>
              ...
              {displayedOrders.map((order: Order) => (
                ...
                >
                  ...
                  <div className="bg-white/5 border border-white/5 p-4 rounded-md space-y-3">
                    <div className="text-xs text-on-surface-variant font-semibold uppercase tracking-wider mb-2">
                      Ordered Items:
                    </div>
                    <div className="space-y-3">
                      {order.items.map((item, index) => (
                        ...
                        >
                          ...
                          <span className="text-on-surface-variant font-mono whitespace-nowrap">
          ...
          <div className="max-w-md mx-auto text-center py-12 glass-panel p-8 rounded-lg border border-white/5">
            <XCircle
              size={48}
              className="mx-auto text-red-400 mb-4 opacity-75"
            />
