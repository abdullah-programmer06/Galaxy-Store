...
import { collection, doc, getDoc, setDoc, onSnapshot, getDocs, updateDoc, deleteDoc } from 'firebase/firestore';
...
export const defaultSettings: SiteSettings = {
  staff: [{ email: 'abubokkorbaqi@gmail.com', role: 'Admin' }],
  contactInfo: {
...
const defaultProducts: AdminProduct[] = [
  ...
  },
  {
    ...
    basePrice: 79,
    variants: [
      { id: '1', name: 'Weekly Lite', price: 79, stock: 'In Stock' },
    ]
  },
  {
    id: 'level-up-pass',
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'v3', name: 'Online Starter Pack', price: 14.99, stock: 'In Stock' },
    ]
  },
  {
    id: 'valor-protocol',
    title: 'Valor Protocol',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCj94WKFbKay6kHvr0ZSQE3BnetqLicU8AIapsHVwTCi0pcloDDCHFKBfRhlML-BEXXjanetBKmfVSL6Eq0QBJ48fahE7KFuprtGlq2tTm_AK7FXNiLZst_hAiGzyB-2Afb6ldDZ1zNzrS92b65Trcb4iNSWy3lcSlHfFmiBJE1XfnPCzpvW7edLH5ADpRMarS9lT_paPyACpgyanPQBiB0ALEYpJskPlgm6UkvnWttkoO3uGHAXsL_',
    category: 'Games',
    folder: 'PC',
    basePrice: 19.99,
    description: 'Top up VP Points for seasonal cosmetics and battle passes.',
    variants: [
      { id: 'vp1', name: '1000 VP', price: 19.99, stock: 'In Stock' }
    ]
  },
  {
    id: 'unknown-battlegrounds',
    title: 'Unknown Battlegrounds',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCcxc28KfLd2WS5Az_pcOk2HdSHqJiy_6p_N094T2oyBO7ybB8FWs7pnE7mH3qox9O7Tu36O0gXfDZYplqVOsKw-p0ltypkHPLdHrIKDxQeEBin8lze02JphkXSwmLrx7OtgAb7R4aepG93MMEcY-rWIom2_1oXR2J2VQRrlyj0eWOF9lgs95x2jXmB4o_pKmLsk34j1emSDs821axbIaZU51g51NiR-9Y80Ry5L7NvewYLXV218VOM',
    category: 'Games',
    folder: 'Mobile',
    basePrice: 9.99,
    description: 'Instant delivery for UC cash. Enhance your loadout instantly.',
    variants: [
      { id: 'ub1', name: '600 UC', price: 9.99, stock: 'In Stock' }
    ]
  },
  {
    id: 'genshin-chronicles',
    title: 'Genshin Chronicles',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBIsXraf3nWomM4Xfj6sg_tkWcYzlC0uzWqRNJkZrhlSPVytmXFNmDZS6TqzAA_xD5p-YhN-mIDreTfv2O_gDI5l9xaq6_X07td7KUUOcHsRXOfSJI0iF4MZ8uVAY7ZTZOtSeD0MmdJDLObGpm3JGGkJxAM2KcxZOO4003VyO1s6E8s_uj_Jg0fHpoYgp0v-3aEtFU_n-fJKcv6-VOllQ1BprMAH4scA_AU1KCW4DxtHQs49d4SAhFI',
    category: 'Games',
    folder: 'Multi',
    basePrice: 29.99,
    description: 'Purchase Genesis Diamonds safely and securely.',
    variants: [
      { id: 'gc1', name: '1980 Genesis Crystals', price: 29.99, stock: 'In Stock' }
    ]
  },
  {
    id: 'discord-nitro',
  ...
  },
  {
    ...
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDXF0xPmTeW1vKZZq_zBkMAxquaCSzk4vokOFtllvAddQvOr8hVsE0-RIRVZGK6B8nxsNqYmjNnyKUbSO_G49Uu9q1kcMuaZQEveUE8sage961beZxSRgA08eNpMhpCtPZ48vpzFwZTCaOR0tEyNrHmb0voalQ22kpYku9boWuEof0o33LzWBQ_UhK2oPL3veX7yxkyGxxbJ7XpsBs5pBmKa_lFHx_x0IExGfgfdX4biTQ1SQVDEjU9',
    category: 'Software',
    folder: 'Operating System',
    basePrice: 169.99,
    description: 'Upgrade your battlestation with the latest features, enhanced security, and directx 12 ultimate support for maximum gaming performance.',
    variants: [
  ...
  },
  {
    ...
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAOcqq96XgOv0mtCRobPrHXi7iDZ5vspVDWKn08TgYnSff_xL_VPopk8ZQUObGchzYrcnsu9HIDzhIBLpH-72Po0xrBF4mvnrL2lupCAMtDN6QnYOgbDPc2l6iZ1kGxTdNzQhKqb_HEJWaZE3oFO2QfSfksn6d_yHh0S7BFkzs9bXwvwQrypcL8RwwzUHFdECymac1EbXi9k11omjXa_BoYswHkRlqnXIYhNEZBMHYln49ffhyjeN1C',
    category: 'Software',
    folder: 'Creative Suite',
    basePrice: 599.99,
    description: '1-Year Subscription to all Creative Cloud apps.',
    variants: [
      { id: 'a1', name: '1 Year Subscription', price: 599.99, stock: 'In Stock' }
    ]
  },
  {
    id: 'office-2021-professional',
    title: 'Office 2021 Professional',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBs5TmA6bz0eFFMfS5SVgOd_Vm00byGz65WtNh3eaMq1DF_LUSRDGAo_FlYpePKezf_cYSEmhwMg5oLPFxetKcVt5QG-nu6TbZcNM8LxwOCYwZJXBQWpHGvkck7oUJQpI0uUIaqp6CGm1Fc-iVq4WAgO96nN_nFoJHpaD281J5J3mVR3clIqolkoTrK2YMAoHp50JPrvvGAEFXK-hzPusUAZCVDdZcRFQnfcCZysVd-HNHaUPh1_faC',
    category: 'Software',
    folder: 'Productivity',
    basePrice: 39.99,
  ...
  },
  {
    ...
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDqFi-i02I_hb-toDlPREgE4EJ8HECUucJDuvMvxS2TQ4pXE627gmfGVj1CHsQO13I-CQVVWAKz3bDUnJipwSUmG7CKRZUeCnoj0_CA9_FXstHvpoNS2d0R3229DtbXNRpsnQNJPbvjjCtpVYLkaZpC57zLZU54Z4USBRe_hdzYMDBAfMGbiOpaquVnR2fycxgkRYylF2sEjAKwWrmH9iervg4aVg8yztQK_oW7FmK5HIe7x_e2BpNd',
    category: 'Software',
    folder: 'Gift Card',
    basePrice: 50.00,
    description: 'Instant digital delivery of Steam Wallet Code.',
    variants: [
      { id: 's1', name: '$50 Code', price: 50.00, stock: 'In Stock' }
    ]
  },
  {
    id: 'xbox-game-pass-ultimate',
    title: 'Xbox Game Pass Ultimate',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBwOwm7ueQHJv8U7MOs_feWXI5rgNXFqcWfuVKzuiI4WB3CWDdP_qnvzdKXM61at6691bEO4UBXEjVZ6Q67PjqomGa8OBR-YEZPGvad3r7m-JZP-pThqK7_pAbs629z-BSJoGxOXaNTdcuQmBuqKbsE0wYNj7UapjW1LpkM5iOsR7DZzjZYlzuq5bsYH7JO13j5BfeNFiQ83cJvnOHskrsHp1dq2132T2CiRlEdaPR5OmSH6Cf_xNqY',
    category: 'Software',
    folder: 'Gift Card',
    basePrice: 44.99,
  ...
  },
  {
    ...
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAEBILcwyid15s-v8-WXDt9Sjm6fxVfJ2iy3xrCYnsZy17bGEJWKlMVF68PXOfSVxjbiDv4jX3D0TVgwZQWSdYRJMkATv72eESIOFzejACDbTkew3bZwsx40rvJKKbFQ7eJNa0mXz1IFdzCVCF000d8eSZHDXcVvrAxsaBj5ZfCaM_1pS-ISnuTg3jjoI9lNSP2IOhOYOPSriqZ3arr_Ln3-zuVSjxUjP37-OuSR-TxViprvHFoIKzX',
    category: 'Software',
    folder: 'Gift Card',
    basePrice: 100.00,
    description: 'App Store, iTunes & More gift card code.',
    variants: [
      { id: 'ap1', name: '$100 Code', price: 100.00, stock: 'In Stock' }
    ]
  },
  {
    id: 'netflix',
    ...
    variants: [
      ...
      { id: 'v2', name: '4 Screens (1 Month)', price: 15.99, stock: 'In Stock' },
    ]
  }
];
...
const defaultOrders: Order[] = [
  { id: 'ORD-001', user: 'Alex H.', email: 'alex@example.com', items: [{ id: '1', title: 'Valorant 2050 VP', price: 19.99 }], amount: 19.99, date: '2026-07-11', status: 'Completed', paymentMethod: 'bKash' },
  { id: 'ORD-002', user: 'Sarah M.', email: 'sarah@example.com', items: [{ id: '2', title: 'Netflix Premium', price: 15.99 }], amount: 15.99, date: '2026-07-12', status: 'Pending', paymentMethod: 'Nagad' },
  { id: 'ORD-003', user: 'John D.', email: 'john@example.com', items: [{ id: '3', title: 'Free Fire 1000 Diamonds', price: 9.99 }], amount: 9.99, date: '2026-07-10', status: 'Completed', paymentMethod: 'Rocket' },
  { id: 'ORD-004', user: 'Mike T.', email: 'mike@example.com', items: [{ id: '4', title: 'Spotify Premium', price: 29.99 }], amount: 29.99, date: '2026-07-10', status: 'Cancelled', paymentMethod: 'Visa Card' },
];
...
export function useAdminData() {
  ...
  useEffect(() => {
    ...
    const unsubSettings = onSnapshot(doc(db, 'config', 'settings'), (docSnap) => {
      if (docSnap.exists()) {
        ...
        setDoc(doc(db, 'config', 'settings'), defaultSettings);
      }
    });
    ...
    // Home Sections
    const unsubHome = onSnapshot(collection(db, 'home_sections'), (snapshot) => {
      const sections: HomeSection[] = [];
      snapshot.forEach(d => sections.push(d.data() as HomeSection));
      if (sections.length === 0) {
        defaultHomeSections.forEach(s => setDoc(doc(db, 'home_sections', s.id), s));
      } else {
  ...
  const updateSettings = async (updates: Partial<SiteSettings>) => {
    await setDoc(doc(db, 'config', 'settings'), { ...settings, ...updates }, { merge: true });
  };
  ...
  const addProduct = async (newProduct: Omit<AdminProduct, 'id' | 'variants'>) => {
  ...
  const removeProductCategory = async (categoryOrFolder: string) => {
    ...
    snapshot.forEach(async (d) => {
      ...
      if (data.category === categoryOrFolder || data.folder === categoryOrFolder) {
        await deleteDoc(doc(db, 'products', d.id));
      }
    });
  };

  const updateProductVariants = async (productId: string, variants: PackageVariant[]) => {
  ...
  const addHomeSection = async (title: string) => {
    ...
    await setDoc(doc(db, 'home_sections', id), { id, title, products: [] });
  };
  ...
  const updateHomeSection = async (id: string, updates: Partial<HomeSection>) => {
    await updateDoc(doc(db, 'home_sections', id), updates);
  };

  const addProductToSection = async (sectionId: string, product: Omit<HomeSectionProduct, 'id'>) => {
    const section = homeSections.find(s => s.id === sectionId);
    if (section) {
      const newProduct = { ...product, id: Math.random().toString(36).substr(2, 9) };
      await updateDoc(doc(db, 'home_sections', sectionId), {
